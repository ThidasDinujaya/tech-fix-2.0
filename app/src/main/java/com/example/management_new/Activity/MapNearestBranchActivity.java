    ...
    private void searchCustomLocation() {
        ...
        try {
            ...
            if (addresses != null && !addresses.isEmpty()) {
                ...
                // Add search location pin on map
                mMap.addMarker(new MarkerOptions().position(currentSearchLatLng).title("Searched Location: " + locationName));

                // Find nearest branch relative to typed location
            ...
            e.printStackTrace();
            Toast.makeText(this, "Geocoder service error. Try again.", Toast.LENGTH_SHORT).show();
        }
    }
